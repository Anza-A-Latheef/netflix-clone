        ...
        <div className='flex wrapper h-[522px] bg-black'>
            <div className="h-full">
                <div className='relative w-[508px] h-[381px] pt-[60px]'>
                    ...
                    <div className='absolute  bg-black items-center w-[16rem] border-2 rounded-lg border-solid  p-[5px] border-color gap-3 flex z-1 top-[85%] left-[25%] h-fit'>
                        ...
                        <div className='w-[30px] h-[30px] shadow-custom bg-cover bg-no-repeat content-none bg-gif'>
            ...
            <div className="flex flex-col h-full justify-center">
                <h2 className='text-white font-extrabold text-[50px] leading-relaxed'>Download your shows to watch offline</h2>
