                        ...
                        <div className='mt-3'>
                            <ul className='flex items-center justify-between'>
                                <li className='headli w-[100%] grid grid-cols-3 text-left'>
                                    ...
                                    {starList?.cast && starList.cast.length > 0 ? ( starList.cast.map((actor, index) => (
                                    <p key={index} className='smallp text-base text-white'> {actor.original_name} </p> ))) : ( <p className='smallp text-base text-white'>N/A</p> )}
                                </li>
                            </ul>
                        </div>
                    </div>
